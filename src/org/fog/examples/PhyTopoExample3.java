...
import org.fog.placement.ModulePlacementOnlyCloudSingleInstance;
 ...
 */
public class PhyTopoExample3 {
	
	private static int NUM_EDGE_SW = 1;
	...
	public static void main(String[] args) {
		...
		try {
			...
			broker.submitApplication(application, 0, 
					new ModulePlacementOnlyCloudSingleInstance(fogDevices, sensors, actuators, application));
